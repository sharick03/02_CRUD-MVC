...
<form action="usuario" method="post">
    ...
    <div class="login-info-container">
        ...
        <center><img src="assets/img/usuario.png" height="150" width="150"></center>
            <input class="input" type="text" name="nombreUsuario" id="nombreUsuario" placeholder="Nombre Usuario">                <input class="input" type="text" name="apellidoUsuario" id="apellidoUsuario" placeholder="Apellido Usuario">
